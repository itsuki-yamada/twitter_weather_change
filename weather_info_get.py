...
def weather_search(town_name: str = "2112518") -> int:
    ...
    # URL = f'http://api.openweathermap.org/data/2.5/weather?units=metric&q={town_name}&APPID={OPEN_WEATHER_KEY}'
    # URL = f'http://api.openweathermap.org/data/2.5/weather?lat=35&lot=1&APPID={OPEN_WEATHER_KEY}'
